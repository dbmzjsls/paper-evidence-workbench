---
applyTo: "api.py,main.py,src/config.py,src/models.py,src/indexing.py,src/storage.py,src/evidence.py,src/parser.py,src/bulid_db.py,src/parsers/**/*.py,tests/**/*.py"
---
